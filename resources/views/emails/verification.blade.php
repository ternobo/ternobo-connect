            ...
            <div style="text-align: center;">
                ...
                <div class="container" style="width: 100%;">
                    <div class="col-md-6" style="margin: auto;text-align: right;">
                        ...
                        <p>باسلام و تشکر بابت عضویت در ترنوبو</p>
                        <p>جهت تایید ایمیل و یا ادامه فرایند ثبت نام در وبسایت، از کد زیر استفاده کنید:</p>
                        <p style="text-align:center;"><a style="color: rgb(95, 93, 126);text-decoration: none;font-size: 1.5rem;font-weight: 600;">{{ $vcode }}</a></p>
                        <p>اگر این درخواست از جانب شما ارسال نشده، این پیام را نادیده بگیرید</p>
                        <p>ممکن است این درخواست به اشتباه از سمت دیگر کاربران ارسال شده باشد.</p>
                        <p>باتشکر</p>
