...
return [
    ...
    'no-posts' => "هیچ محتوایی وجود ندارد",
    ...
    "weak-password" => "رمزعبور ضعیف است!",
    "no-block-user" => "تا کنون هیچ کاربری را مسدود نکرده‌اید",

    "unfollow-user" => "دنبال نکردن :name؟ شما دیگر محتوای آن‌ها را در صفحه خانه مشاهده نمی‌کنید.",
    "delete-endoser-confirm" => "آیا از حذف این تایید مهارت مطمئن هستید؟",
    "mobile-maintenance" => "ورژن موبایل ترنوبو در حال حاضر دردسترس نیست. می‌توانید از طریق دسکتاپ به ترنوبو دسترسی پیدا کنید.",

    "sms" => [
        "sms_saved" => "کد فعالسازی در دیتابیس ذخیره شد",
        "sms_sended" => "کد فعالسازی ارسال شد"
    ],
    "invalid-otp" => "کد تایید نامعتبر است",
    "expired-otp" => "کد تایید منقضی شده",
    "success-otp" => "شماره موبایل تایید شد",
