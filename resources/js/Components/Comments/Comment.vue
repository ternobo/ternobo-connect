    ...
    <div class="comment" v-if="!deleted">
        <div class="comment-header">
            <inertia-link :href="'/'+comment.page.slug" class="d-flex align-items-center">
                <img :src="comment.page.profile" class="profile-md">
        ...
        <div class="w-100 d-flex align-content-center justify-content-between pt-2">
            ...
            <div class="actions">
                <i @click="loadReplies" :class="{'material-icons-outlined':!showReplies,'material-icons': showReplies}" class="hover-dark clickable">
                    insert_comment
                </i>
...
export default {
    ...
    methods: {
        ...
        likeComment() {
            ...
            axios
                .post(this.$APP_URL + "/comments/" + this.comment.id + "/like");
        },
        loadReplies() {
            ...
            if (this.showReplies) {
                ...
                axios
                    ...
                    }).catch((error) => console.log(error)).then(() => this.repliesLoading = false);

            }
        },
        deleteComment() {
            this.deleted = true;
            axios.delete("/posts/" + this.comment.post_id + "/comments/" + this.comment.id).
            then((response) => {
