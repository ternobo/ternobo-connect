<template>
	<div class="position-relative" v-click-outside="hideList">
		<button class="btn btn-action-light rounded-circle" @click="toggleList"><i class="material-icons font-20">add</i></button>
		<div class="editors-actions-list" style="left: -290px; top: 0" v-if="showList">
			...
			<div class="text-type-list">
				<div class="editor-list-item">
					<strong>رسانه</strong>
					<i class="material-icons-outlined" :class="{ disabled: !activeOptions.includes('media') }" @click="emitAcion('image')">image</i>
				</div>
				<div class="editor-list-item">
