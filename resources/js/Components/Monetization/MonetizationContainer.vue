	...
	<div class="monitization-container">
		...
		<div class="card p-6">
			<div class="monitization-card-header">
				...
				<loading-button class="btn btn-primary text-nowrap" v-if="monitizationStatus == null || monitizationStatus == 'rejected'" @click="sendMonetizationRequest" :loading="loading" :disabled="!status.status">{{ __.get("monitization.send-request") }}</loading-button>
