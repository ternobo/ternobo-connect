  ...
  <b-modal v-model="showModal" hide-footer hide-header @show="onShow" body-class="pb-0" ref="modal" size="lg">
    <div class="useroptions">
      ...
      <ul class="p-0 menu">
        ...
        <li class="list-item d-flex flex-column">
          <inertia-link href="/ideas" class="m-0"><i class="material-icons-outlined">emoji_objects</i> صدای شما </inertia-link>
        </li>
        <li class="list-item d-flex flex-column">
          <inertia-link href="/help" class="m-0"><i class="material-icons-outlined">help_outline</i> مرکز راهنمایی </inertia-link>
        </li>
      </ul>
      <div class="langs">
