<template>
<b-modal v-if="$page.user != null" v-model='showModal' :no-close-on-backdrop="isCropping" hide-footer body-class="px-2 pb-2" size="md" title="تولید محتوای تازه" :centered="true">
