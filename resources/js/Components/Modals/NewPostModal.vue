<template>
	<b-modal v-if="$page.props.user != null" v-model="showModal" :no-close-on-backdrop="isCropping" hide-footer body-class="px-3 pb-2" size="md" title="تولید محتوای تازه" :centered="true">
