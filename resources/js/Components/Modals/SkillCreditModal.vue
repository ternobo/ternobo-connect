<template>
	<b-modal v-if="$page.props.user != null" v-model="showModal" no-close-on-backdrop hide-footer body-class="pb-0" :title="'تایید مهارت ' + user.name" size="md" :centered="true">
		<p>
