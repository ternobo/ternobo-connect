	...
	<b-modal v-model="showModal" hide-footer size="md" title="چرا می‌‌خواهید این صفحه را گزارش دهید؟" :centered="true">
		<div class="reportreseaons" v-if="reportFor == null">
			...
			<div class="report-item" @click="reportFor = 'fakeorspam'">
				<span class="text">فکر می‌کنم <span class="reportTitle">این صفحه</span> جعلی، هرز یا کلاهبراری است‌</span>
				<i class="material-icons">keyboard_arrow_left</i>
			</div>
			<div class="report-item" @click="reportFor = 'other-reasons'">
				<span class="text">برای گزارش <span class="reportTitle">این صفحه</span> دلایل دیگری دارم</span>
				<i class="material-icons">keyboard_arrow_left</i>
			</div>
		</div>
		...
		<div v-if="!moreInfo">
			...
			<div class="fakeorspam reportfor" v-if="reportFor === 'fakeorspam'">
				...
				<div class="report-reason">
					...
					<div class="radio clickable" @click="reason = 'فکر می‌‌کنم این صفحه دارای اطلاعات نادرست است'">
						<input type="radio" name="reason" value="فکر می‌‌کنم این صفحه دارای اطلاعات نادرست است" class="radio__input" v-model="reason" />
						<label class="radio__label"> </label>
					</div>
				</div>
				<div class="report-reason">
					...
					<div class="radio clickable" @click="reason = 'فکر می این صفحه هرز است'">
						<input type="radio" name="reason" value="فکر می این صفحه هرز است" class="radio__input" v-model="reason" />
						<label class="radio__label"> </label>
					</div>
				</div>
				<div class="report-reason">
					...
					<div class="radio clickable" @click="reason = 'فکر می‌‌کنم این صفحه جهت کلاهبرداری، فیشینگ یا انتقال ویروس و باج افزار ارائه شده'">
						<input type="radio" name="reason" value="فکر می‌‌کنم این صفحه جهت کلاهبرداری، فیشینگ یا انتقال ویروس و باج افزار ارائه شده" class="radio__input" v-model="reason" />
						<label class="radio__label"> </label>
					</div>
				</div>
			</div>
			...
			<div class="other-reasons reportfor" v-if="reportFor === 'other-reasons'">
				<div class="report-reason">
					...
					<div class="radio clickable" @click="reason = 'فکر می‌کنم این صفحه توهین آمیز است'">
						<input type="radio" name="reason" value="فکر می‌کنم این صفحه توهین آمیز است" class="radio__input" v-model="reason" />
						<label class="radio__label"> </label>
					</div>
				</div>
				<div class="report-reason">
				...
				<div class="report-reason">
					...
					<div class="radio clickable" @click="reason = 'فکر می‌کنم  این صفحه اشاعه دهنده خشونت و تروریسم است'">
						<input type="radio" name="reason" value="فکر می‌کنم  این صفحه اشاعه دهنده خشونت و تروریسم است" class="radio__input" v-model="reason" />
						<label class="radio__label"> </label>
					</div>
				</div>
				<div class="report-reason">
					...
					<div class="radio clickable" @click="reason = 'فکر می‌‌کنم این صفحه آزار دهنده و تهدید آمیز است'">
						<input type="radio" name="reason" value="فکر می‌‌کنم این صفحه آزار دهنده و تهدید آمیز است" class="radio__input" v-model="reason" />
						<label class="radio__label"> </label>
					</div>
				</div>
				<div class="report-reason">
				...
				<div class="report-reason">
					...
					<div class="radio clickable" @click="reason = 'این صفحه حقوق شخصی مرا نقض می‌کند'">
						<input type="radio" name="reason" value="این صفحه حقوق شخصی مرا نقض می‌کند" class="radio__input" v-model="reason" />
						<label class="radio__label"> </label>
					</div>
				</div>
			</div>
