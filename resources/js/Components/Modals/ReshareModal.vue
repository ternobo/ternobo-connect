<template>
<b-modal v-if="$page.user != null" v-model='showModal' no-close-on-backdrop hide-footer size="md" title="تولید محتوای تازه" :centered="true">
...
export default {
    ...
    methods: {
        ...
        submitPost() {
            ...
            axios.post(this.$APP_URL + '/share/' + this.post.id, formData)
                .then((response) => {
