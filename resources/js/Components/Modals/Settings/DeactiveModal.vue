<template>
<b-modal v-model='showModal' hide-footer title="غیرفعال کردن حساب" size="lang" :centered="true">
    <div class="d-flex flex-column align-items-center">
        ...
        <div class="mt-3">
            ...
            <p>
                در صورتی بیش از <strong class="text-danger">۲ سال</strong> حساب کاربری شما غیرفعال باشد تمامی اطلاعات«پست‌ها، مقالات، اطلاعات پروفایل و صفحه شخصی و صفحات شرکتی» شما به طور <strong class="text-danger">غیرقابل بازگشتی</strong> حذف خواهد شد.
            </p>
