		...
		<div class="container">
			<div class="section-3 d-flex justify-content-center pb-5">
				<div class="text-center flex-column d-flex align-items-center">
					...
					<span class="pb-5 font-16 spPr">طراحی و آماده&zwnj;سازی یک رزومه کامل، بی&zwnj;نقص و حرفه&zwnj;ای دغدغه&zwnj;ای است که همه ما به نوعی با آن درگیر هستیم، به کمک ترنوبو شما می&zwnj;توانید رزومه آنلاین خودتان را در کوتاه&zwnj;ترین زمان و به سادگی هرچه تمام&zwnj;تر در کمتر از ۲ دقیقه ایجاد و آن را به صورت فایل PDF هم دریافت نمایید.</span>
