		...
		<div class="container">
			<div class="d-flex align-items-center w-100">
				...
				<form method="get" action="/search" ref="searchfield" class="searchfield d-flex">
					<auto-complete class="search-field w-100" inputClass="rounded" icon="search" v-model="searchVal" @suggestionclick="submitsearch" @search="submitsearch" required type="text" :suggestionPosition="17" name="q" :placeholder="__.get('application.searchq')" />
