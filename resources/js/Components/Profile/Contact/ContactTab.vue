    ...
    computed: {
        showWebsites() {
            if (this.checkUser(this.page.user_id) ||
                (this.page.contact_data != null && this.page.contact_data.websites != null && this.page.contact_data.websites.length > 0)) {
                return true;
            }
            return false;
        },
        showContacts() {
            if (this.checkUser(this.page.user_id) ||
                (this.page.contact_data != null && this.page.contact_data.contacts != null && this.page.contact_data.contacts.length > 0)) {
                return true;
            }
            return false;
        },
        showSocials() {
            if (this.checkUser(this.page.user_id) ||
                (this.page.contact_data != null && this.page.contact_data.socials != null && this.page.contact_data.socials.length > 0)) {
                return true;
            }
            return false;
        }
