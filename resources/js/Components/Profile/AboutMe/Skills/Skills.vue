...
<div class="card">
    <div class="card-body">
        <div class="d-flex mb-2 aling-items-center justify-content-between">
            ...
            <button class="btn follow-btn rounded-pill px-3 py-1" style="min-width: 48px" v-if="edit" @click="addSkill">
        ...
        <span class="text-action pb-2 clickable" @click="showMore = true" v-if="!showMore && skills != null && skills.length > 3 && !edit">نمایش تمام مهارت‌ها</span>
    </div>
</div>
</template>
