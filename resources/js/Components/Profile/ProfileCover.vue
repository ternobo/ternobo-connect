...
<div class="card-img-top position-relative page-cover">
    ...
    <CropperModal title="انتخاب تصویر پروفایل" v-if="canChange" :show.sync="crop" :aspect-ratio="96 / 18" :image="image" @cropped="upload"></CropperModal>
    ...
    <i class="material-icons-outlined closebtn" v-if="canChange" @click="openFileSelect">edit</i>
</div>
</template>
...
export default {
    ...
    methods: {
        ...
        upload(cordinates) {
            ...
            axios.post(this.$APP_URL + '/setcover', formData)
                .then((response) => {
