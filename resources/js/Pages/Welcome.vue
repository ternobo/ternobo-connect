	...
	<div class="container-fluid">
		...
		<div class="header px-3 d-flex justify-content-between align-items-center">
			...
			<div class="d-flex">
				...
				<button v-if="!$page.props.user" class="btn btn-transparent border-left" :class="{ 'text-dark': !hasBG }" @click="showLogin = !showLogin">ورود</button>
				<button v-if="!$page.props.user" class="btn btn-transparent" :class="{ 'text-dark': !hasBG }" @click="showSignup = !showSignup">ثبت‌نام</button>
			</div>
		</div>
